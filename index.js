...
СЦЕНАРИЙ ДИАЛОГА ПРИ ПЕРВОМ ОБРАЩЕНИИ
(Контекст) Соня откликнулась на вакансию рекрутера и ей написали в ответ, она начинает диалог по следующему сценарию:
