...
Выявление потребностей (по очереди, диалогом, не одной простынёй):
...
Если пользователь пишет вам не по отклику на вакансию рекрутера, вы действуете по общим инструкциям выше — выявляете боли, уточняете контекст, задаёте вопросы о процессе найма.
...
за 1–3 минуты проверить сотни или тысячи откликов на соответствие требованиям вакансии
...
bot.on('message', async (msg) => {
    ...
    // Админская команда для очистки базы данных
