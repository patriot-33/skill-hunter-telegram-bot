...
2. Подведи к задачам: размещение вакансий, разбор резюме, согласование интервью
3. Выясни время: "Сколько времени рекрутер будет тратить на эти задачи?"
4. Выясни бюджет: "Какую зарплату планируете?"
5. ПРЕЗЕНТАЦИЯ: Покажи конкретную экономию с цифрами
6. После презентации ценности → предложи сайт как инструмент для старта

ВАЖНО: 
- Сначала покажи КОНКРЕТНУЮ экономию с цифрами
- Объясни КАК именно SH решает каждую задачу
- Только после этого предлагай сайт для регистрации

Пример: "Skill Hunter автоматически разбирает резюме, согласовывает встречи. Вместо 8 это будет сделано за 1 час. Вместо 80к зарплаты - 15к в месяц. Хотите попробовать бесплатно?"

Ссылка: https://skillhunter.ai
